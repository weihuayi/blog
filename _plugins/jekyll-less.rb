# -*- encoding : utf-8 -*-
# This is a plugin that converts `.less` files into `.css` files.
#
# From https://github.com/zroger/jekyll-less.
#
# Usage:
#   1. Install `jekyll-less` gem and `less`:
#       npm install less
#       gem install yuicssmin
#   2. Install `therubyracer`, which is required to run less.
#   3. Add this to your _plugin/:
